    ...
    <div class="max-w-2xl mx-auto mt-8 p-8 bg-white shadow-lg rounded-lg mb-12">
      <form on:submit|preventDefault={handleSubmit} class="space-y-6">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <div>
            <label for="tlf" class="block text-sm font-medium text-gray-700 mb-1">Telefon nr.</label>
            <input id="tlf" type="tel" bind:value={tlf} required class="block w-full px-4 py-3 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-lg" />
          </div>
          <div>
          ...
          <div>
            ...
            <input id="cvr" type="text" bind:value={cvr} required class="block w-full px-4 py-3 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-lg" />
          </div>
        </div>
        <div>
