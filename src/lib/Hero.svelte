  ...
  >
    <div class="flex flex-col items-center">
      ...
      <a 
        ...
        class="btn btn-wide uppercase tracking-wider glass bg-orange-500 hover:bg-orange-400 text-base-100 border-none text-sm sm:text-base transition-all duration-300 ease-in-out"
      >
        Ring nu
      </a>
    </div>
